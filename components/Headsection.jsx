    ...
    <main>
        ...
        <section className='grid md:grid-cols-5 gap-8 py-12 px-12 bg-gray-100 md:px-20'>
          <div className="shadow-lg p-6 rounded bg-white size-100">
            <iframe src="https://www.linkedin.com/embed/feed/update/urn:li:ugcPost:7297807241011699712?collapsed=1" frameborder="0" allowfullscreen="" title="Embedded post" className='w-fit h-fit'></iframe>
          </div>
